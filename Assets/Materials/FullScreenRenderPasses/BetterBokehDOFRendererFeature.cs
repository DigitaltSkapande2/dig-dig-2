...
public sealed class BetterBokehDOFRendererFeature : ScriptableRendererFeature
{
    ...
    public override void Create()
    {
        ...
        if (m_Material == null)
            m_Material = UnityEditor.AssetDatabase.LoadAssetAtPath<Material>("Assets/Materials/FullScreenRenderPasses/Anton_BokehDepthOfField.mat");
#endif
    ...
    public override void AddRenderPasses(ScriptableRenderer renderer, ref RenderingData renderingData)
    {
        ...
        BetterBokehDOFVolumeComponent myVolume = VolumeManager.instance.stack?.GetComponent<BetterBokehDOFVolumeComponent>();
