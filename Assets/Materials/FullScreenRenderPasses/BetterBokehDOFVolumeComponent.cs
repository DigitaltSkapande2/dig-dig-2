...
[VolumeComponentMenu("Post-processing Custom/BetterBokehDOF")]

// If the related Scriptable Renderer Feature doesn't exist, display a warning about adding it to the renderer.
[VolumeRequiresRendererFeatures(typeof(BetterBokehDOFRendererFeature))]
...
[DisplayInfo(name = "BetterBokehDOF")]

// Create the Volume Override by inheriting from VolumeComponent
public sealed class BetterBokehDOFVolumeComponent : VolumeComponent, IPostProcessComponent
{
